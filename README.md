...
目前在`package com.senjoeson.wechat.api`包中有两个静态类，即`MessageTools`和`WechatTools`，目前对外暴露的方法有：
...
对于收到的消息，itchat4j将其以POJO类的形式进行了封装，即在`package com.senjoeson.wechat.beans`包中的`BaseMsg类`，其声明如下：
...
import com.senjoeson.wechat.api.MessageTools;
import com.senjoeson.wechat.api.WechatTools;
import com.senjoeson.wechat.beans.BaseMsg;
import com.senjoeson.wechat.beans.RecommendInfo;
...
import com.senjoeson.wechat.utils.tools.DownloadTools;
...
```Java
package com.senjoeson.wechat.demo.demo2;
